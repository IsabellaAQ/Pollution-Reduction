...
<html>
	<head>
		...
		<style type="text/css">
			form a input{
				/*los estilos se encuentran aquí porque hay problemas para conectarse con el la carpeta de estilos, donde se encuentra todo el diseño*/
				width: 200px;
				height: 50px;
				text-align: center;
				margin: auto;
	...
	<body>
		...
		<div id="ContSuperior">
				...
				<div id="bus2">
						<a href="medios_transporte.html"><img src="imagenes/bus2.png"></a>
							<article id="bus2">
								<h1>Bus</h1>
								<h3>Cuando viajas en bus ahorras mucho más<br>
									y además evitas la conaminación <br>
								en un porcentaje considerable</h3>
								<form action="db/bus.php" method="post">
