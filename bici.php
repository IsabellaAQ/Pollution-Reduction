...
<html>
	...
	<body>
		...
		<div id="ContSuperior">
				...
				<div id="bici2">
						<a href="medios_transporte.html"><img src="imagenes/bici2.png"></a>
							<article>
								<h1>Bicicleta</h1>
								<h3>Mejoras tu salud, ahorras combustible; <br>
									la bici no produce gases tóxicos, además <br>
								ocupa menos espacio</h3>
								<form action="db/bici.php" method="post">
